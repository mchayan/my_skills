...
# chart_image = pie_chart.render("skills_manoj_pie.png")

# # Display the chart image using Plotly
...
# # Display the pie chart using st_pyecharts with a unique key argument
# st_pyecharts(pie_chart, key="skills_pie_chart")

# # Display the coding animation
# st_lottie(lottie_skills, speed=1, width=300, height=300)
